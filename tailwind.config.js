...
export default {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'dropdown': '0 10px 15px -3px rgba(0, 0, 0, 0.3), 0 4px 6px -4px rgba(0, 0, 0, 0.2)',
      },
      ...
      keyframes: {
        ...
        // Custom animations
        'pulse-glow': {
          '0%, 100%': { opacity: '1', boxShadow: '0 0 20px rgba(6, 182, 212, 0.15)' },
          '50%': { opacity: '0.8', boxShadow: '0 0 40px rgba(6, 182, 212, 0.3)' },
        },
        'float': {
      ...
      animation: {
        ...
        'slide-in-up-fast': 'slide-in-up 0.15s ease-out',
        'slide-in-up-slow': 'slide-in-up 0.5s ease-out',
      },
  ...
  plugins: [
    ...
    function({ addUtilities, addComponents, theme }) {
      ...
      addComponents({
        '.btn-cyber': {
          '@apply relative overflow-hidden px-6 py-3 bg-gradient-to-r from-cyan-500 to-blue-600 text-white rounded-xl font-semibold transition-all duration-300': {},
          '&::before': {
            content: '""',
            position: 'absolute',
            top: '0',
        ...
        '.card-cyber': {
          '@apply bg-slate-800/50 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-6 transition-all duration-300': {},
          '&:hover': {
            '@apply border-cyan-500/30 shadow-lg shadow-cyan-500/10 -translate-y-1': {},
          },
        },
      });
    },
